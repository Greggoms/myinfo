...
export const data = [
  {
    ...
    email: "kavs1031@gmail.com",
    position: "Associate",
    hireDate: hireDate(2022, 1, 6),
    lifetimePTO: lifetimePTO(2022, 1, 6),
    daysUntil10Hrs: daysUntil10Hrs(2022, 1, 6),
    remainingPTO: remainingPTO(2022, 1, 6, 0, 0),
    monthsWorked: {
      total: monthsWorked(2022, 1, 6),
      asPosition: monthsWorked(2022, 1, 6),
    },
    timeForRaise: timeForRaise(2022, 1, 6, "Associate"),
    eligible: eligibleAmount(2022, 1, 6, "Associate"),
    pay: 11,
  },
  {
    id: uuidv4(),
    ...
    lastName: "Prevette",
    location: "VW Jacksonville",
    email: "breannaprevette@gmail.com",
    position: "Associate",
    hireDate: hireDate(2022, 1, 6),
    lifetimePTO: lifetimePTO(2022, 1, 6),
    daysUntil10Hrs: daysUntil10Hrs(2022, 1, 6),
  ...
  },
  {
    ...
    email: "zachdover96@icloud.com",
    position: "Associate",
    hireDate: hireDate(2022, 1, 5),
    lifetimePTO: lifetimePTO(2022, 1, 5),
    daysUntil10Hrs: daysUntil10Hrs(2022, 1, 5),
    remainingPTO: remainingPTO(2022, 1, 5, 0, 0),
    monthsWorked: {
      total: monthsWorked(2022, 1, 5),
      asPosition: monthsWorked(2022, 1, 5),
    },
    timeForRaise: timeForRaise(2022, 1, 5, "Associate"),
    eligible: eligibleAmount(2022, 1, 5, "Associate"),
    pay: 11.5,
  },
  {
    id: uuidv4(),
    ...
    lastName: "King",
    location: "Warehouse",
    email: "jasonmartinking01091981@gmail.com",
    position: "Associate",
    hireDate: hireDate(2022, 1, 3),
    lifetimePTO: lifetimePTO(2022, 1, 3),
    daysUntil10Hrs: daysUntil10Hrs(2022, 1, 3),
    remainingPTO: remainingPTO(2022, 1, 3, 0, 0),
    monthsWorked: {
      total: monthsWorked(2022, 1, 3),
      asPosition: monthsWorked(2022, 1, 3),
    },
    timeForRaise: timeForRaise(2022, 1, 3, "Associate"),
    eligible: eligibleAmount(2022, 1, 3, "Associate"),
    pay: 17.5,
  },
  {
    id: uuidv4(),
  ...
  },
  {
    ...
    firstName: "Jeremy",
    lastName: "Pate",
    location: "VW HS Central",
    email: "Pategaming@gmail.com",
    position: "Associate",
    hireDate: hireDate(2021, 12, 20),
    lifetimePTO: lifetimePTO(2021, 12, 20),
    daysUntil10Hrs: daysUntil10Hrs(2021, 12, 20),
    remainingPTO: remainingPTO(2021, 12, 20, 0, 0),
    monthsWorked: {
      total: monthsWorked(2021, 12, 20),
      asPosition: monthsWorked(2021, 12, 20),
    },
    timeForRaise: timeForRaise(2021, 12, 20, "Associate"),
    eligible: eligibleAmount(2021, 12, 20, "Associate"),
    pay: 11,
  },
  {
    id: uuidv4(),
  ...
  },
  {
    ...
    remainingPTO: remainingPTO(2020, 11, 29, 40, 0),
    accepted: [
      {
        dates: ["1/3/2022", "1/9/2022"],
        hours: 40,
      },
    ],
    monthsWorked: {
  ...
  },
  {
    ...
    promotionDate: promotionDate(2021, 12, 28),
    timeForRaise: timeForRaise(2021, 12, 28, "Manager"),
    eligible: eligibleAmount(2021, 12, 28, "Manager"),
    pay: 15,
  },
  {
    id: uuidv4(),
  ...
  },
  {
    ...
    remainingPTO: remainingPTO(2019, 3, 11, 80, 0),
    accepted: [
      {
        dates: ["1/3/2022", "1/9/2022"],
        hours: 40,
  ...
  },
  {
    ...
    remainingPTO: remainingPTO(2018, 8, 13, 56, 0),
    accepted: [
      {
        dates: ["12/24/2021"],
        hours: 8,
