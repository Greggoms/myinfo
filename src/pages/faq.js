  ...
  return (
    <>
      ...
      <div className="page-container">
        <FaqContainer className="page-content">
          <div>
            <div className="w4">
              <h3>W-4 Forms</h3>
              <p>
              ...
              <div className="steps">
                <div className="step1and5">
                  <p>
                    ...
                    employee no matter what your situation is. I’ve received
                    many w4s with missing SSN step 1(b). These are considered
                ...
                <p>
                  ...
                  these steps apply to your situation but you don’t fill them
                  out either because you never had to before, don’t understand
                  what it’s asking, or simply overlooked it, you WILL pay tax at
                  tax time.
                </p>
                <div className="step2">
                  <h4>
                    Step 2 applies to you if at least one of these is true:
                  </h4>
                  <ul>
                ...
                <div className="step3and4">
                  <h4>
                    Step 3 applies to you if at least one of these is true:
                  </h4>
                  <ul>
                  ...
                  <h4>
                    Step 4 applies to you if at least one of these is true:
                  </h4>
                  <ul>
                    <li>You have multiple jobs.</li>
                    <li>
                    ...
                    <li>
                      ...
                      withhold tax. (An income you receive without filing a w4
                      for it). This isn’t common.
                    </li>
                    <li>
                      ...
                      charitable contributions, state and local taxes, and
                      medical expenses). This isn’t common.
                    </li>
                  </ul>
                  <>
                    <blockquote>
            ...
            <details>
              ...
              <p>
                ...
                Withholding”. This is not like the other taxes listed on the
                stub. The federal withholding is an amount you have some control
                of. The other taxes are a mandatory set percentage of your gross
                pay (total amount of your pay before tax).
              </p>
              <p>
                ...
                what is owed, you will have a negative balance and have to pay
                the amount necessary to zero it out. If your balance exceeds
                what is owed, you get a refund for the difference.
              </p>
              <p>
                ...
                this bank account. At the end of the year, let’s say I’m
                expected to pay $1,000 in taxes. Lucky for me, I’ve deposited
                (withheld) X amount from each paycheck and it added up to $1,400
                (visible on stub under YTD column). $1,400 balance - $1,000 owed
                = $400 refund!
              </p>
              <p>
                In a complicated example, I’m married and my spouse and I both
                have at least one job. I check the box “married filing jointly”
                in step 1(c). I assume that the federal withholding will work
                itself out like the example above. At the end of the year, let’s
                say I’m expected to pay $1,000 in taxes. Unfortunately, I
                skipped step 2 and 4(c) or put 0 for step 4(c). Yes it says it’s
                optional, but it is required for this situation if you want to
                withhold the right amount. My IRS account only withheld $100!
                $100 balance - $1,000 owed = $900 OWED. What gives? I filled out
                the w4, so what went wrong?
              </p>
              <p>
                Here’s what went wrong. I filed as married jointly (or as single
                with multiple jobs), so the w4 expects me to account for
                multiple incomes. Oops, I didn’t account for the other income(s)
                in step 2! Because I didn’t do that, I didn’t withhold the right
                amount to be deposited into my invisible bank account and now I
                owe the difference.
              </p>
            </details>
            <details>
              ...
              <p>
                ...
                one job, you typically won’t have to worry about it. At the end
                of the day, it's a game of trial and error. The amount you're
                expected to pay in taxes can change every year due to various
                circumstances, so there is no definite answer
              </p>
              <p>
                For any other situation (multiple jobs, married and spouse
                works), step 2 offers three different ways to calculate this
                amount. You can only choose ONE of the options.
              </p>
              <ol>
                <li>
                  ...
                  for the most accurate withholding. Put the result on step
                  4(c).
                </li>
                <p className="or">OR</p>
                <li>
                ...
                <p className="or">OR</p>
                <li>
                  If there are 2 jobs maximum and both incomes are relatively
                  the same (for example: one job pays $1000 and the other pays
                  $1250), you can check the box on step 2(c). This will perform
                  the automatic withholdings as though you're filing as single
                  and you shouldn’t need to specify an extra amount to be
                  withheld, but it could be a smart idea anyway. If I check this
                  box and my first job pays $1000 while my second job pays
                  $5000, one of these jobs will withhold way more than necessary
                  and will result in a very small net pay (total amount of your
                  pay after tax) on the pay stub. You most likely wouldn't have
                  to worry about paying in though and could receive a refund!
                </li>
              </ol>
              <p>
                ...
                is more than one income to consider but you leave step 4(c)
                blank or input 0, you will not withhold enough and should expect
                to pay in at the end of the year. If the box in step 2(c) is
                checked, it's up to you if you would like to withhold an
                additional amount, but you shouldn't be as affected if you don't
                specify additional withholdings on step 4(c).
              </p>
            </details>
            <details>
              ...
              <p>
                ...
                required fields, and optional fields if they apply to you. We
                can print this for you if needed, though handwritten w-4s are
                least desirable.
              </p>
              <h4>Option 2</h4>
              {!user && (
              ...
              <ul>
                <li>
                  ...
                  {user ? (
                    ...
                    <em>please login to view the password.</em>
                  )}
                </li>
                <li>
              ...
              <p>
                This is the best approach if you want to make sure you don't
                miss any{" "}
              ...
              <p>
                It is required for all new employees to fill out the Form w-4
                from 2020 or later. It is <em>not</em> required to submit a new
                w-4 for existing employees, though I recommend you consider your
                situation in accordance with the changes made to the form. I{" "}
                <em>strongly</em> recommend married or multi-income individuals
                to fill out a new form to calculate for federal withholdings.
              </p>
            </details>
            <details>
          ...
          <div>
            ...
            <details>
              ...
              <h4>Option 1</h4>
              <p>
                Visit your bank and ask them for a Direct Deposit form and
                voided check. Make sure you write VOID across the check and
                attach it to the form. Bring this form to the warehouse, or scan
                it to send to the payroll email.
              </p>
              <h4>Option 2</h4>
              {!user && (
          ...
          <div>
            ...
            <details>
              ...
              <p>
                ...
                to directly edit the file before saving it (as you can do with
                the w-4 form) hasn't been setup yet. It will be available soon.
              </p>
